...
@Service("IncomeDisBatch")
public class IncomeDisBatch implements Serializable, ApplicationContextAware {

	private IncomeDisService incomeDisService;
	private static ApplicationContext context = null;
	private static final Logger logger = Logger.getLogger(IncomeDisBatch.class);
