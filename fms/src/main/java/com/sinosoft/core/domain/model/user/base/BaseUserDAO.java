...
public abstract class BaseUserDAO extends com.sinosoft.core.domain.model.user.dao._RootDAO {
	...
	public static UserDAO getInstance () {
		if (null == instance) instance = new com.sinosoft.core.domain.model.user.dao.UserDAO();
		return instance;
	}
  ...
  public Class getReferenceClass () {
    ...
    public com.sinosoft.core.domain.model.user.User load(java.lang.Integer key)
        throws org.hibernate.HibernateException {
        return (com.sinosoft.core.domain.model.user.User) load(getReferenceClass(), key);
    }

    public com.sinosoft.core.domain.model.user.User get(java.lang.Integer key)
        throws org.hibernate.HibernateException {
	 ...
	 */
	public java.lang.Integer save(com.sinosoft.core.domain.model.user.User user)
		throws org.hibernate.HibernateException {
