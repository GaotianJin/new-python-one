...
/**
 * This is an object that contains data related to the TF_NB_UW_ERROR_TRACE table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="TF_NB_UW_ERROR_TRACE"
 */

public abstract class BaseTfNbUwErrorTrace  implements Serializable {

	public static String REF = "TfNbUwErrorTrace";
	...
	public static String PROP_UW_MASTER_ID = "UwMasterId";
	 ...
	 */
	public BaseTfNbUwErrorTrace (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	private java.lang.Integer uwMasterId;
	...
	/**
	 * Return the value associated with the column: UW_MASTER_ID
	 */
	public java.lang.Integer getUwMasterId () {
		return uwMasterId;
	}

	/**
	 * Set the value related to the column: UW_MASTER_ID
	 * @param uwMasterId the UW_MASTER_ID value
	 */
	public void setUwMasterId (java.lang.Integer uwMasterId) {
		this.uwMasterId = uwMasterId;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.sinosoft.core.domain.model.rule.TfNbUwErrorTrace)) return false;
		else {
			com.sinosoft.core.domain.model.rule.TfNbUwErrorTrace tfNbUwErrorTrace = (com.sinosoft.core.domain.model.rule.TfNbUwErrorTrace) obj;
			if (null == this.getId() || null == tfNbUwErrorTrace.getId()) return false;
			else return (this.getId().equals(tfNbUwErrorTrace.getId()));
		}
	}
