...
function updateProductTabs(){
	...
	$('#updateProductTabs').tabs('add',{
		...
		selected: false,
		closable:true,
		href : contextPath+"/product/updateProductCoreInfoUrl?param="+$.toJSON(param)
	});
	...
	$('#updateProductTabs').tabs('add',{
		...
		selected: false,
		closable:true,
		href : contextPath+"/product/updateProductInternetInfoUrl?param="+$.toJSON(param)
	});
	$('#updateProductTabs').tabs('add',{
		title: '闄勬枃鏈紪杈戝尯',
		selected: false,
		closable:true,
		href : contextPath+"/product/updateProductEditorUrl?param="+$.toJSON(param)
	});
