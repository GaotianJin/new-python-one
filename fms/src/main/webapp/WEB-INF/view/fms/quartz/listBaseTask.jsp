...
<script type="text/javascript"
	src="../js/cis/quartz/listBaseTaskInit.js"></script>
<script type="text/javascript"></script>

<div id="tabdiv">
	<div id="smsaccordion" class="easyui-panel" fit="true" title="基本任务查询"
			...
			<div class="top_table">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td width="200" align="left"><select id="jobtname" name="JobTname"    class="table_select"></select></td>
