...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/fms/sales/detailReissueIdInit.js"></script>


<input type="hidden" name="month" id="detailReissueId_month" class="inpuntHidden" value="${month}">
<div id="tabdiv10" class="outerPanel">
	<div id="smsaccordion" class="easyui-panel" fit="true" title="薪资信息" collapsible="true">
		...
		<div style="margin-top: 3px;" id="tabdiv11">
			<table id="detailReissueIdTable"></table>
		</div>
	</div>
</div>
