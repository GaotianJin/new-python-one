...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/fms/customer/listCustomerSearchInit.js"></script>
...
<div id="tabdiv" class="outerPanel">	
	<div id="smsaccordion" class="easyui-panel" fit="true" title="客户信息" collapsible="true">
		 <form id="listCustSearch_queryConditionForm">
			<div class="top_table">
				<table class='input_table' width="100%" border="0" cellspacing="0" cellpadding="0" >
					<tr>
						...
						<td>
							...
							<input name="comId" id="listCustSearch_comId" class="table_input"/>
						</td>
						<td class="table_text" align="right">部门</td>
						<td align="left">
							<span class="comboSpan"></span>
							<input name="departmentId" id="listCustSearch_DepartmentId" class="table_input"/>
						</td>
						...
						<td>
							<span class="comboSpan"></span>
							<input name="agentId" id="listCustSearch_AgentId" class="table_input"/>
						</td>
					</tr>
					<tr>
						<td class="table_text" align="right">客户号</td>
						<td><input name="customerNo" id="listCustSearch_CustomerNo" class="table_input"/></td>
						<td class="table_text" align="right">中文姓名</td>
						<td align="left"><input name="chnName" id="listCustSearch_ChnName" class="table_input"/></td>
						...
						<td>
							<span class="comboSpan"></span>
							<input name="custLevel" id="listCustSearch_custLevel" class="table_input easyui-combobox1">
						</td>
					</tr>
					<tr>
						...
						<td align="left">
							<span class="comboSpan"></span>
							<input class = "table_input easyui-combobox1" name="custType"  id = "listCustSearch_custType" />
						</td>
						<td class="table_text" align="right">出生月份</td>
						<td align="left">
							<span class="comboSpan"></span>
							<input name="birthMonth" class="table_input easyui-combobox1" id="listCustSearch_birthMonth">
						</td>
