...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/fms/product/detailProductDefInit.js"></script>
				...
				<div class="top_table" id="basicInfo">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="input_table">
						...
						<tr>
							...
							<td align="left">
								<input class="table_input easyui-validatebox" name="productShortName" id="updateProduct_productShortName" data-options="validType:['length[0,100]']"/>
							</td>
