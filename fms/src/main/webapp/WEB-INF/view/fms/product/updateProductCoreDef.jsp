...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/fms/product/updateProductCoreDefInit.js"></script>
			...
			<div class="top_table">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="input_table">
					<tr>
						...
						<td align="left"><input class="table_input easyui-validatebox" name="financingScale" id="modify_financingScale" data-options="required:true,validType:['validDecNum']"/></td>
					</tr>
					<tr>
						<td align="right" class="table_text">风险等级</td>
						<td><span class="comboSpan"></span><input class="table_input easyui-combobox1" id="modify_grade" name="grade" data-options="required:true"></td>
					...
					<tr id="closeDperiods_redemptionFee">
						...
						<input class="table_input easyui-validatebox"  id="modify_redemptionFeeInput"  name="closeDperiodFee"  data-options="validType:['validDecNum']"/></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
				
			        <tr id="floatProductInfo">
						<td id="promptIncomeWay" align="right" class="table_text"><span>收益方式</span></td>
						<td id="promptIncomeWayTd"><span class="comboSpan"></span><input class="table_input easyui-combobox1" id="modifyPdCoreInfo_incomeWay" name="incomeWay" ></td>
				<!-- 		<td align="right" class="table_text">
						<span id="prompthistoryEarnrate">历史收益(%)</span>
						</td>
				    	<td align="left"><input class="table_input easyui-validatebox" name="historyEarnrate" id="modifyPdCoreInfo_historyEarnrate" data-options="validType:['validDecNum']"/></td>
						 -->
						<!-- <td id="prompthistoryEarnrate" class="table_text" align="right" >历史收益(%)</td> 
				        <td id="modifyPdCoreInfo_historyEarnrate" align="left"><input class="table_input easyui-validatebox" name="historyEarnrate"  data-options="validType:['validDecNum']"/></td> -->
						
						<!-- <td id="prompthistoryEarnratePeriod" align="right" class="table_text">
						<span>历史收益期间</span>
						</td>
				    	<td id="modifyPdCoreInfo_historyEarnratePeriod" align="left"><input class="table_input easyui-validatebox" name="historyEarnratePeriod"/></td> -->
...
<!-- 					<tr>
					...
					<tr id="netvaluedisclosure" hidden>
					<td align="right" class="table_text"></span>净值披露频率</td>
						...
						<td><span class="comboSpan"></span><input id="expectOpenDayRules" class="table_input easyui-combobox" name="expectOpenDayRules"  hidden></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
					<tr>
					<td align="right" class="table_text productFeature">产品特点</td>
						...
						<!-- <td align="right" class="table_text productFeature" >产品特点</td>
						<td class="productFeature" colspan="1" ><input class="table_input" id="modify_productFeature"  name="productFeature" /></td> -->
						<!-- <td align="right" class="table_text riskControlMeasure">风控措施</td>
						<td class="riskControlMeasure" colspan="1" ><input class="table_input" id="modify_riskControlMeasure"  name="riskControlMeasure" /></td> -->
					...
					<tr>
						<td align="right" class="table_text riskControlMeasure">风控措施</td>
					 	<td align="left" colspan="5" class="riskControlMeasure">
							<span class="comboSpan"></span>
							<textArea name="riskControlMeasure" id="riskControlMeasure" rows="2" cols="80" class="table_textarea easyui-validatebox" data-options="required:true" ></textArea></td>
					</tr>
					<tr>
					<td align="right" class="table_text raiseAccount">募集账户</td>
					 	<td align="left" colspan="5" class="raiseAccount">
							<span class="comboSpan"></span>
							<textArea name="raiseAccount" id="raiseAccount" rows="2" cols="80" class="table_textarea easyui-validatebox" data-options="required:true" ></textArea></td>
						<!-- <td align="right" class="table_text raiseAccount">募集账户</td>
						<td class="raiseAccount" colspan="1" ><input class="table_input" id="modify_raiseAccount"  name="raiseAccount"/></td> -->
						<!-- <td align="right" class="table_text trusteeshipAccount">托管账户</td>
						<td class="trusteeshipAccount" colspan="1" ><input class="table_input" id="modify_trusteeshipAccount" name="trusteeshipAccount"/></td> -->
					</tr>
					<tr>
					<td align="right" class="table_text trusteeshipAccount">托管账户</td>
					 	<td align="left" colspan="5" class="trusteeshipAccount">
							<span class="comboSpan"></span>
							<textArea name="trusteeshipAccount"  id="trusteeshipAccount" rows="2" cols="80" class="table_textarea easyui-validatebox" data-options="required:true" ></textArea></td>
					</tr>
					...
					<tr>
						...
						<!-- <td class="investDirection" colspan="3" hidden><input id="investDirection" class="table_input1 easyui-validatebox"  name="investDirection" data-options="required:true"/></td> -->
						...
						<!-- <td class="investStrategy" colspan="3" hidden><input id="investStrategy" class="table_input1 easyui-validatebox"  name="investStrategy" data-options="required:true"/></td> -->
						<td align="right" class="table_text investScope" hidden>投资范围</td>
						<!-- <td class="investScope" colspan="3" hidden><input id="investScope" class="table_input1 easyui-validatebox"  name="investScope" data-options="required:true"/></td> -->
