...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/fms/product/listNetWorthFindInit.js"></script>
		...
		<form id="netValueForm">
			<div class="top_table">
				<table class='input_table' width="100%" border="0" cellspacing="0">
					<tr>
						...
						<td><span class="comboSpan"></span> <input
							class="table_input easyui-combobox" id="list_net_agencyComId"
							name="agencyComId"></td>
						<td class="table_text" align="right">产品</td>
						<td align="left"><span class="comboSpan"></span> <input
							class="table_input easyui-combobox" id="list_net_productId"
							name="productId"></td>
						<td class="table_text" align="right">公布日期</td>
						<td><span class="comboSpan"></span> <input
							name="publicDateStartDate" id="list_publicDateStartDate"
							class="table_input2 easyui-datebox"> 至 <input
							name="publicDateEndDate" id="list_publicDateEndDate"
				...
				<div>
					...
					<a href="#" onclick="searchNetValue()" class="easyui-linkbutton e-cis_button"  iconCls="icon-search">查询</a>
				</div>
			</div>
		</form>
