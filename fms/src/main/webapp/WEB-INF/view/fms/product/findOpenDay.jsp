...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/fms/product/findOpenDayInit.js"></script>
<!-- 开放日查询 -->
			...
			<div class="top_table">
				<table class='input_table' width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<input class="table_input easyui-combobox" id="find_openDayAgencyComId" name="agencyComId"></td>
						<td class="table_text" align="right">产品</td>
						<td align="left">
							<span class="comboSpan"></span>
							<input class="table_input easyui-combobox" id="find_openDayProductId" name="productId">
						</td>
						<td class="table_text" align="right" >开放日</td>
						<td>
							<span class="comboSpan"></span>
							<input name="openDayStartDate" id="find_openDayStartDate" class="table_input2 easyui-datebox">
							至
							<input name="openDayEndDate" id="find_openDayEndDate" class="table_input2 easyui-datebox">
						</td>
					</tr>
				</table>
				<div>
