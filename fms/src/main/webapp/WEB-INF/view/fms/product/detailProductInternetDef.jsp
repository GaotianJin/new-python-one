...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/fms/product/detailProductInternetDefInit.js"></script>
			...
			<div class="top_table">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="input_table">
						...
						<tr>
							...
							<td><span class="comboSpan"></span>
							<input class="table_input easyui-combobox" id="updatePdInternet_isShowFirst" name="isShow"></td>
						    <td>&nbsp;</td>
						    <td>&nbsp;</td>
						</tr>
				</table>
