...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/fms/index/updateComNewsFileInit.js"></script>

<input type="hidden" name="companyNewsInfoId" id="updComNews_companyNewsInfoId" value="${companyNewsInfoId}">

<div id="tabdiv" class="outerPanel">
<form id="updComNewsUeditor" method="post">
		<table width="150%" border="0" cellspacing="0" cellpadding="0" class="input_table">
			<tr>
							<td class="table_text" align="right">标题</td>
							<td align="left">
								<input class="table_input easyui-validatebox" name="title" id="updComNews__title" data-options="required:true,validType:['length[0,100]']"/>
							</td>
...
<a href="#" onclick="updateComNewsEditorInfo()" class="easyui-linkbutton e-cis_button" iconCls="icon-tick">更新</a>
