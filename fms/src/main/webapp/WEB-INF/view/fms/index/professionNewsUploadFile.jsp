...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/fms/index/professionNewsUploadFileInfoInit.js"></script>
...
<form id="proNewsFileUeditor" method="post">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="input_table">
			<tr>
							<td class="table_text" align="right">标题</td>
							<td align="left">
								<input class="table_input easyui-validatebox" name="title" id="proNewsUploadFile_title" data-options="required:true,validType:['length[0,100]']"/>
							</td>
			</tr>
		</table>
   <!-- 加载编辑器的容器 -->
...
<a href="#" onclick="saveFileUploadInfo()" class="easyui-linkbutton e-cis_button" iconCls="icon-tick">保存</a>
