...
<script type="text/javascript" src="../js/cis/thirdparty/monitorLog/MonitorLogQueryInit.js"></script>
<script type="text/javascript"></script>

<div id="tabdiv">
<div id="smsaccordion" class="easyui-panel" fit="true" title="监控日志查询" iconCls="icon-ok" collapsible="true">
