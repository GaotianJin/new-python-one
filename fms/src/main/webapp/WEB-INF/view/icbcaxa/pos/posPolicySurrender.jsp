...
<script type="text/javascript" src="../js/icbcaxa/pos/posPolicySurrenderInit.js"></script>
<form id="posTypeForm">
		...
		<div class="top_table">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td align="left"><input name="effencientdate" id="effencientdate" class="easyui-datebox" value="${effencientdate}" data-options="required:true"></td>
				</tr>
				<tr>
							<td width="125" class="table_text" align="right">保全任务号</td>
							<td width="200" align="left"><input name="posID"
								id="posID" class="table_input" value="${posID}" disabled="disabled"></td>
		...
		<div class="top_table">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td align="left">
					<input name="tempfee" id="tempfee" type="text" class="table_input" value="${tempfee}" disabled="disabled">
					</td>
					<td class="table_text" align="right">合同退费总金额</td>
					<td align="left">
					<input name="totalfee" id="totalfee" class="table_input" value="${totalfee}" disabled="disabled">
					</td>
				</tr>
			</table>
		</div>
