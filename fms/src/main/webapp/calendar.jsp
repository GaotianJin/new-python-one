...
<STYLE TYPE="text/css" MEDIA=screen>
    input.cssButton{BORDER-RIGHT: #799AE1 1px solid; PADDING-RIGHT: 2px; BORDER-TOP: #799AE1 1px solid; PADDING-LEFT: 2px; FONT-SIZE: 12px; FILTER: progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=#ffffff, EndColorStr=#799AE1); BORDER-LEFT: #AABFEC 1px solid; CURSOR: hand; COLOR: black; PADDING-TOP: 2px; BORDER-BOTTOM: #AABFEC 1px solid;}
    button.cssButton{BORDER-RIGHT: #799AE1 1px solid; PADDING-RIGHT: 2px; BORDER-TOP: #799AE1 1px solid; PADDING-LEFT: 2px; FONT-SIZE: 12px; FILTER: progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=#ffffff, EndColorStr=#799AE1); BORDER-LEFT: #AABFEC 1px solid; CURSOR: hand; COLOR: black; PADDING-TOP: 2px; BORDER-BOTTOM: #AABFEC 1px solid;}
</STYLE>
...
GZ.innerHTML = yDisplay +'年 农历 ' + cyclical(SY-1900+36) + '年 【<strong>'+Animals[(SY-4)%12]+'</strong>年】';
...
break;
case 'MU' :     //上个月
if(CLD.SM.selectedIndex>0) { CLD.SM.selectedIndex--;
}
else {
...
<BODY leftMargin=0 topMargin=10 onload=initial() background="b.jpg">
...
<TABLE>
  ...
  <TR>
    ...
    <BR>
    <FONT style="FONT-SIZE: 9pt" size=2>本机时间:</FONT>
    <BR>
    <FONT id=Clock face=Arial color=#000080 size=4 align="center"></FONT>
      <P>
      <!--时区 *表示自动调整为日光节约时间-->
      <FONT style="FONT-SIZE: 9pt" size=2><SELECT style="FONT-SIZE: 9pt" onchange=changeTZ() name=TZ> 
      <OPTION  value="-1200 安尼威土克、瓜甲兰" selected>国际换日线
      <OPTION 
        value="-1100 中途岛、萨摩亚群岛">萨摩亚<OPTION value="-1000 夏威夷">夏威夷
        <OPTION 
        value=-0900*阿拉斯加>阿拉斯加<OPTION value=-0800*太平洋时间(美加)、提亚纳>太平洋
        <OPTION 
        value=-0700*亚历桑那>美国山区<OPTION value=-0700*山区时间(美加)>美加山区
        <OPTION 
        value=-0600*萨克其万(加拿大)>加拿大中部<OPTION value=-0600*墨西哥市、塔克西卡帕>墨西哥
        <OPTION 
      ...
      value="+1200 斐济、肯加塔、马歇尔群岛">斐济</OPTION></SELECT>时间 </FONT>
      <BR><FONT id=Clock2 face=Arial color=#000080 size=4 align="center"></FONT>
      <BR><FONT style="FONT-SIZE: 120pt; COLOR: green; FONT-FAMILY: Webdings">&ucirc;</FONT>
      <BR><FONT id=CITY style="FONT-SIZE: 9pt; WIDTH: 150px; COLOR: blue; FONT-FAMILY: '新细明体'"></FONT>
      </P></TD>
    <TD align=middle>
      ...
      <TABLE border=0>
        <TBODY>
        <TR>
          <TD  colSpan=7 align=middle><FONT style="FONT-SIZE: 12pt" 
            ...
            //--></SCRIPT>
            </SELECT>月 </FONT><FONT id=GZ face=标楷体 color=green 
            size=3></FONT><BR></TD></TR>
        <TR align=middle >
          <TD width=54 align=middle><strong><FONT color=red>星期日</FONT></strong></TD>
          <TD width=54 align=middle><strong>星期一</strong></TD>
          <TD width=54 align=middle><strong>星期二</strong></TD>
          <TD width=54 align=middle><strong>星期三</strong></TD>
          <TD width=54 align=middle><strong>星期四</strong></TD>
          <TD width=54 align=middle><strong>星期五</strong></TD>
          <TD width=54 align=middle><strong><FONT color=red>星期六</FONT></strong></TD></TR>
        <SCRIPT language=JavaScript>
        <!--
            var gNum
            for(i=0;i<6;i++) {
    ...
    <BUTTON class=cssButton style="FONT-SIZE: 9pt" onclick="pushBtm('YU'); return false;">上一年</BUTTON><BR>
    <BUTTON class=cssButton style="FONT-SIZE: 9pt" onclick="pushBtm('YD'); return false;">下一年</BUTTON><P>
    <BUTTON class=cssButton style="FONT-SIZE: 9pt" onclick="pushBtm('MU'); return false;">上个月</BUTTON><BR>
    <BUTTON class=cssButton style="FONT-SIZE: 9pt" onclick="pushBtm('MD'); return false;">下个月</BUTTON><P>
    <BUTTON class=cssButton style="FONT-SIZE: 9pt" onclick="pushBtm(''); return false;">转今日</BUTTON></P>
...
<!--  <input style="FONT-SIZE: 13pt" size="35" name="q"><input type="hidden" value="aff-sowang" name="client"><input type="hidden" value="GB2312" name="ie"><input type="hidden" value="UTF8" name="oe"><input type="hidden" value="zh-CN" name="hl"><input type="hidden" value="searchbutton3" name="channel"><input class=cssButton style="FONT-SIZE: 11pt; COLOR: #000000" type="submit" value="中科软搜索"></td> -->
</form> 
<td vAlign="center" style="font-family: 宋体; font-size: 12px" width="4"> 
</td></td> 
</tr> 
</table>
<FONT style="FONT-SIZE: 10pt" face=ARIAL size=2><FONT color=red></FONT><FONT color=red></FONT><FONT color=red>
 <%=userCode%>您好，欢迎登录本系统！</FONT></FONT>
<br> 
<FONT style="FONT-SIZE: 10pt" face=ARIAL size=2><FONT color=red></FONT>新的一天开始了，记得看看日历上的<FONT color=red></FONT><FONT color=red>节日</FONT>，祝您天天快乐！</FONT>
...
color=blue>蓝色</FONT>则表示为公众节假日<BR></CENTER></FONT></FONT>
	<form name="fm" action="" method="post" target=_top>
		<table width="749" height="500" border="0" align="center" cellpadding="0" cellspacing="0">
			<tr> 
				<td height="500" width="749" valign="top"> 			
				<MARQUEE scrollAmount=2 scrollDelay=4 width=900 align="up" direction="left" onMouseOver="this.stop()" onMouseOut="this.start()" > 
				</MARQUEE> 
				</td> 
			</tr> 
