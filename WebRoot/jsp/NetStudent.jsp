...
<script src="js/myjs/bingtu.js"></script>
<script src="js/myjs/ditu.js"></script>
<style type="text/css">
.red {
	color: red;
}
...
<script type="text/javascript">
  ...
  function setShowColumn(){
	...
	function addDynamic(index){
		var rows=$('#stuInfo').datagrid("getRows");
		var data=rows[index];
		if(data.askerName==null){
			$.messager.alert("系统提示","该学生无咨询师，无法添加动态！");
			return;
		}
	...
	function searchRoleStus(){
		StushowPies();
		$('#RoleStu').window("open");
	}
	function searchStuAddress(){
		showStuAddress();
		$('#StuAddress').window("open");
	}
</script>
</head>
...
<body>
	...
	<table id="stuInfo" title="学生信息" class="easyui-datagrid"
		...
		pageSize="20" toolbar="#tb" url="/EighthCRMItem/showAllStudent.eighth">
		<thead>
			<tr>
				<th field="stuId" checkbox="true" width="10px">编号</th>
				<th field="stuName" align="center" width="80px">学员姓名</th>
				<th field="askerId" align="center" width="100px" hidden="true">咨询师Id</th>
	...
	<div id="tb" style="padding:3px">
		<a class="easyui-linkbutton" iconCls="icon-add" plain="true"
			...
			onclick="downloadInfo()">导出Excel</a> <a class="easyui-linkbutton"
			iconCls="icon-edit" plain="true" onclick="getStuId()">批量操作</a>
		<a class="easyui-linkbutton"
			iconCls="icon-search" plain="true" onclick="searchRoleStus()">老师学生关系图</a>
		<a class="easyui-linkbutton"
			iconCls="icon-search" plain="true" onclick="searchStuAddress()">学生住址分布图</a>
	</div>
			...
			<table border="1" bordercolor="#a0c6e5"
				...
				<tr>
					...
					<td><input class="easyui-datetimebox" id="nextFollowTime"
						name="nextFollowTime"
						data-options="validType:'equaldDate[\'#followTime\']'">
					</td>
				</tr>
				<tr>
					<td>备注:</td>
				...
				<tr>
					<td colspan="4" align="center"><a class="easyui-linkbutton"
						...
						onclick="$('#addFollow').window('close')">取消</a></td>
				</tr>
			</table>
		</form>
	</div>
		...
		<table>
			<tr>
				...
				<td><input class="easyui-combobox" id="changeName"
					data-options="panelHeight:'auto',valueField:'askerId',textField:'askerName',url:'/EighthCRMItem/showAllAsker.eighth'" />
				</td>
				<td><a href="javascript:void(0)" class="easyui-linkbutton"
					iconCls="icon-save" plain="true" onclick="savePiLiang()">保存修改</a>
				</td>
			</tr>
		</table>
	</div>
	...
	<div id="RoleStu" class="easyui-window" title="关系图"
		data-options="iconCls:'icon-search',minimizable:false,closed:true,modal:true"
		style="width:650px;padding:10px;top: 50px;">
		<div id="echart" style="width: 600px;height: 400px;"></div>
		
	</div>
	<div id="StuAddress" class="easyui-window" title="河南省各地学生数量分布图"
		data-options="iconCls:'icon-search',minimizable:false,closed:true,modal:true"
		style="width:650px;padding:10px;top: 50px;">
		<div id="echart1" style="width: 600px;height: 600px;"></div>
