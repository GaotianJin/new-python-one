...
<body>
	...
	<table id="stuInfo" title="学生信息" class="easyui-datagrid"
		...
		pageSize="20"
		url="/EighthCRMItem/showAllStudentByAskerIdInMyStu.eighth" toolbar="#tb">
		<thead>
			<tr>
			...
			<table border="1" bordercolor="#a0c6e5"
				...
				<tr>
					...
					<td><input id="sex" name="stuSex" class="easyui-combobox"
						data-options="editable:false,valueField:'id',textField:'text',panelHeight:'auto',
                    data:[{'id':'未知','text':'未知','selected':true},{'id':'男','text':'男'},{'id':'女','text':'女'}]" />
					</td>
	...
	data-options="iconCls:'icon-edit',minimizable:false,closed:true,modal:true"
