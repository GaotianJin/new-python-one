   ...
   function getDetail(obj){
	...
	function formatAction(value, row, index) {
		...
		return '<a class="easyui-linkbutton l-btn l-btn-small l-btn-plain" iconcls="icon-search" plain="true" onclick="showStu('+ "'"+ index+ "'"+ ')"><span class="l-btn-left l-btn-icon-left"><span class="l-btn-text">查看</span><span class="l-btn-icon icon-search">&nbsp;</span></span></a>'+ 
		       '<a class="easyui-linkbutton l-btn l-btn-small l-btn-plain" iconcls="icon-edit" plain="true" onclick="editStu('+ "'"+ index+ "'"+ ')"><span class="l-btn-left l-btn-icon-left"><span class="l-btn-text">编辑</span><span class="l-btn-icon icon-edit">&nbsp;</span></span></a>'+ 
		       '<a class="easyui-linkbutton l-btn l-btn-small l-btn-plain" iconcls="icon-add" plain="true" onclick="createFollow('+ "'"+ r.stuId+ "',"+ "'"+ r.stuName+ "'"+ ')"><span class="l-btn-left l-btn-icon-left"><span class="l-btn-text">跟踪</span><span class="l-btn-icon icon-add">&nbsp;</span></span></a>'+ 
		       '<a class="easyui-linkbutton l-btn l-btn-small l-btn-plain" iconcls="icon-remove" plain="true" onclick="deleteStu('+ "'"+ r.stuId+ "'"+ ')"><span class="l-btn-left l-btn-icon-left"><span class="l-btn-text">删除</span><span class="l-btn-icon icon-remove">&nbsp;</span></span></a>'+ 
		       '<a class="easyui-linkbutton l-btn l-btn-small l-btn-plain" iconcls="icon-search" plain="true" onclick="showLog('+ "'"+ r.stuId+ "'"+ ')"><span class="l-btn-left l-btn-icon-left"><span class="l-btn-text">日志</span><span class="l-btn-icon icon-search">&nbsp;</span></span></a>';
	}
  ...
  function setShowColumn(){
	...
	function downloadInfo(){
		...
		if(selectedRows.length==0){
			...
			var ids=strIds.join(",");
			//$.post("/EighthCRMItem/outExcel.eighth",{stuIds:ids},function(){});
			window.location.href="/EighthCRMItem/outExcel.eighth?stuIds="+ids;
		}
...
<body>
		...
		<tbody>
			<tr>
				...
				<td><input
					...
					style="border: 1px solid #ccc" id="s_phone" name="s_phone" />
				</td>
			</tr>
			<tr>
				<td>咨询师:</td>
			...
			<tr>
				<td>创建时间：</td>
				<td><input class="easyui-datebox" name="dateA" id="dateA" /></td>
				<td style="text-align:center">-</td>
				<td colspan="4"><input class="easyui-datebox" id="dateB"  
					name="dateB" />&nbsp;&nbsp; <a class="easyui-linkbutton"
					iconCls="icon-search" onclick="searchStu()">查询</a>
					<a class="easyui-linkbutton" iconCls="icon-search" onclick="resultSearchStu()">重置</a>
				</td>
			</tr>
		</tbody>
	</table>
	<table id="stuInfo" title="学生信息" class="easyui-datagrid"
		...
		pageSize="20"
		url="/EighthCRMItem/showAllStudent1.eighth" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="firstVisitTime" align="center" width="130px" formatter="formatterDate">首次回访时间</th>
				<th field="isHome" align="center" width="60px">是否上门</th>
				<th field="homeTime" align="center" width="130px" formatter="formatterDate">上门时间</th>
				<th field="preMoney" align="center" width="60px">订金金额</th>
				<th field="preMoneyTime" align="center" width="130px" formatter="formatterDate">订金时间</th>
				<th field="isPay" align="center" width="60px">是否缴费</th>
				<th field="payTime" align="center" width="130px" formatter="formatterDate">缴费时间</th>
				...
				<th field="inClassTime" align="center" hidden="true" width="130px" formatter="formatterDate">进班时间</th>
	...
	<div id="tb" style="padding:3px">
		<a class="easyui-linkbutton"
			iconCls="icon-edit" plain="true" onclick="setShowColumn()">设置</a> <a
			href="javascript:void(0)" class="easyui-linkbutton"
			iconCls="icon-save" plain="true" onclick="downloadInfo()">导出Excel</a>
		<a class="easyui-linkbutton"
			iconCls="icon-edit" plain="true"
			onclick="getStuId()">批量操作</a>
	</div>
		...
		<fieldset>
			...
			<table id="disColumn">
				...
				<tr>
					...
					<td><input type="checkbox" name="check" value="msgSource" checked="checked" />来源渠道</td>
	...
	<div id="createStu" class="easyui-window" title="新建学员"
		...
		<form id="addStudentForm" method="post">
			<table border="1" bordercolor="#a0c6e5"
				...
				<tr hidden="true">
					<td>ID</td>
					<td><input id="stuId" name="stuId" class="easyui-validatebox"/></td>
				</tr>
				<tr>
					<td rowspan="6"
						style="width:20px;padding:7px;font-size:13px;background-color:aliceblue">在线录入</td>
					<td style="min-width:100px">姓名<span class="red">*</span>
					</td>
					<td><input id="name" name="stuName" class="easyui-validatebox"
						data-options="required:true,validType:'chinesename'" />
					</td>
				...
				<tr>
					...
					<td><input id="address" name="stuAddress"
						...
						data-options="editable:true,valueField:'id',textField:'text',panelHeight:'auto',
	                       data:[{'id':'未知','text':'未知','selected':true},{'id':'其它','text':'其它'},
				...
				<tr>
					...
					<td><input id="weixin" name="stuWeiXin"
						class="easyui-validatebox" data-options="validType:'weiXin'" />
					</td>
					<td>是否报备</td>
				...
				<tr style="height:100px">
					...
					<td colspan="5"><input id="content" name="content"
						...
						style="border:none;width:97%;height:100px;resize:none" />
					</td>
				</tr>
			</table>
			<table border="1" bordercolor="#a0c6e5"
				...
				<tr>
					...
					<td><input class="easyui-validatebox" id="ziXunName" type="text"
						name="ziXunName" />
					</td>
					...
					<td><input id="record" name="record"
						class="easyui-combobox"
						data-options="editable:false,valueField:'id',textField:'text',panelHeight:'auto',
				...
				<tr>
					<td>是否有效</td>
					<td><input id="isValid" name="isValid"
						class="easyui-combobox"
						data-options="editable:false,valueField:'id',textField:'text',panelHeight:'auto',
				...
				<tr>
					...
					<td colspan="3"><input class="easyui-datetimebox" type="text"
						name="firstVisitTime" id="firstVisitTime" />
					</td>
				</tr>
				<tr>
					<td>是否上门</td>
					<td><input id="isHome" name="isHome"
						class="easyui-combobox"
						data-options="editable:false,valueField:'id',textField:'text',panelHeight:'auto',
                    data:[{'id':'否','text':'否','selected':true},{'id':'是','text':'是'}]" />
                    </td>
				...
				<tr>
					...
					<td>定金时间</td>
					<td colspan="3"><input class="easyui-datetimebox" type="text"
						id="preMoneyTime" name="preMoneyTime" />
					</td>
				</tr>
				<tr>
					<td>是否缴费</td>
					<td><input id="isPay" name="isPay"
						class="easyui-combobox"
						data-options="editable:false,valueField:'id',textField:'text',panelHeight:'auto',
                    data:[{'id':'否','text':'否','selected':true},{'id':'是','text':'是'}]" />
                    </td>
				...
				<tr>
					...
					<td>退费原因</td>
					<td colspan="3"><input class="easyui-validatebox"
						id="returnMoneyReason" name="returnMoneyReason" />
					</td>
				</tr>
				<tr>
					<td>是否进班</td>
					...
					<td><input class="easyui-datetimebox" type="text"
						id="inClassTime" name="inClassTime" />
					</td>
					<td>进班备注</td>
					<td><input class="easyui-validatebox"
						id="inClassContent" name="inClassContent" />
					</td>
				</tr>
				<tr>
					<td>咨询师备注</td>
			...
			<div style="text-align: center;">
				...
				iconCls="icon-ok">保存</a> <a onclick="$('#createStu').window('close');"
				class="easyui-linkbutton" iconCls="icon-cancel">关闭</a>
			</div>
	</div>
	

	<div id="addFollow" class="easyui-window" title="新建跟踪"
		data-options="iconCls:'icon-add',minimizable:false,closed:true,modal:true"
		style="width:550px;height:300px;padding:10px;top: 100px;">
		<form id="addFollowForm" method="post">
			<table border="1" bordercolor="#a0c6e5"
				...
				<tr>
					...
					<td>回访时间:</td>
					<td><input class="easyui-datetimebox" id="followTime"
						name="followTime"></td>
					<td>回访情况:</td>
					<td><input id="followState" name="followState"
						class="easyui-combobox"
						data-options="editable:false,valueField:'id',textField:'text',panelHeight:'auto',
                          data:[{'id':'思量','text':'思量','selected':true},
                                {'id':'未上门','text':'未上门'},
                                {'id':'上门未报名','text':'上门未报名'},
                                {'id':'报名未进班','text':'报名未进班'},
                                {'id':'已进班','text':'已进班'},
				...
				<tr>
					<td>跟踪方式:</td>
					<td><input id="followType" name="followType"
						class="easyui-combobox"
						data-options="editable:false,valueField:'id',textField:'text',panelHeight:'auto',
					...
					<td>下次跟踪时间:</td>
					<td><input class="easyui-datetimebox" id="nextFollowTime"
						name="nextFollowTime" data-options="validType:'equaldDate[\'#followTime\']'"></td>
				</tr>
				<tr>
					<td>备注:</td>
					<td colspan="3"><input id="content" name="content"
						class="easyui-textbox" data-options="multiline:true"
						style="border:none;width:97%;height:100px;resize:none;font-size:13px" />
					</td>
				</tr>
				<tr>
					<td colspan="4" align="center"><a class="easyui-linkbutton"
						iconCls="icon-save" onclick="saveNetFollow()">保存</a> <a
						class="easyui-linkbutton" iconCls="icon-cancel"
						onclick="$('#addFollow').window('close')">取消</a>
					</td>
				</tr>
			</table>
		</form>
		...
		<form id="LookStudentForm">
			<table border="1" bordercolor="#a0c6e5"
				...
				<tr>
					<td rowspan="7"
						style="width:20px;padding:7px;font-size:13px;background-color:aliceblue">在线录入</td>
					<td style="min-width:70px">姓名<span class="red">*</span>
					</td>
				...
				<tr style="height:100px">
					...
					<td colspan="5"><input style="border: 0px;"
						readonly="readonly" name="content" /></td>
				</tr>
				<!-- ------------------------------------------------------------------------------------- -->
				<tr>
					<td rowspan="10"
				...
				<tr>
					<td>姓名(咨询)</td>
					<td><input style="border: 0px;" readonly="readonly"
						id="ziXunName" name="ziXunName" />
					</td>
					<td>课程方向</td>
					<td><input style="border: 0px;" readonly="readonly"
						id="learnForward" name="learnForward" />
					</td>
					<td>打分</td>
					<td><input style="border: 0px;" readonly="readonly"
				...
				<tr>
					...
					<td colspan="3"><input style="border: 0px;"
						readonly="readonly" name="lostValid" id="lostValid" />
					</td>
				</tr>
				<tr>
					<td>是否回访</td>
					<td><input style="border: 0px;" readonly="readonly"
						name="isReturnVist" id="isReturnVist" />
					</td>
					<td>首访时间</td>
					<td colspan="3"><input style="border: 0px;"
				...
				<tr>
					<td>是否上门</td>
					<td><input style="border: 0px;" readonly="readonly"
						name="isHome" id="isHome" />
					</td>
					<td>上门时间</td>
					<td colspan="3"><input style="border: 0px;"
						readonly="readonly" name="homeTime" id="homeTime" />
					</td>
				</tr>
				<tr>
					<td>定金数额</td>
					<td><input style="border: 0px;" readonly="readonly"
						id="preMoney" name="preMoney" />
					</td>
					<td>定金时间</td>
					<td colspan="3"><input style="border: 0px;"
						readonly="readonly" id="preMoneyTime" name="preMoneyTime" />
					</td>
				</tr>
				<tr>
					<td>是否缴费</td>
				...
				<tr>
					<td>是否退费</td>
					<td><input style="border: 0px;" readonly="readonly"
						id="isReturnMoney" name="isReturnMoney" />
					</td>
					<td>退费原因</td>
					<td colspan="3"><input style="border: 0px;"
						readonly="readonly" id="returnMoneyReason"
						name="returnMoneyReason" />
					</td>
				</tr>
				<tr>
					<td>是否进班</td>
					<td><input style="border: 0px;" readonly="readonly"
						id="isInClass" name="isInClass" />
					</td>
					<td>进班时间</td>
					<td><input style="border: 0px;" readonly="readonly"
						id="inClassTime" name="inClassTime" />
				...
				<tr>
					<td colspan="7" style="text-align: center;"><a
						...
						onclick="$('#LookStu').window('close')">关闭</a>
					</td>
				</tr>
			</table>
		</form>
	...
	<div id="searchFollowWindow" class="easyui-window"
		data-options="title:'跟踪日志',modal:true,iconCls:'icon-search',resizable:false,modal:true,closable:true,collapsible:false,minimizable:false,maximizable:false,closed:true"
		style="width: 750px; height: 300px; top:100px;padding:10px">
		<table id="followList" class="easyui-datagrid" pagination="true"
			pageSize="20" rownumbers="true" title="跟踪信息">
			<thead>
				<tr>
					<th field="studentName" width="10%" align="center">学生名称</th>
					<th field="followTime" width="20%" align="center"
						formatter="formatterDate">跟踪时间</th>
					<th field="content" width="35%" align="center">内容</th>
					<th field="nextFollowTime" width="20%" align="center"
						formatter="formatterDate">下次跟踪时间</th>
					<th field="xx" align="center" width="10%" align="center"
						formatter="logAction">操作</th>
				</tr>
			</thead>
		</table>
	</div>
	<div id="changeAsker" class="easyui-window" title="修改咨询师"
	data-options="iconCls:'icon-edit',minimizable:false,maximizable:false,closed:true,modal:true"
	style="padding: 10px;top: 100px;">
		<table>
			<tr>
				<td>咨询师：</td>
				<td><input class="easyui-combobox" id="changeName" 
				data-options="panelHeight:'auto',valueField:'askerId',textField:'askerName',url:'/EighthCRMItem/showAllAsker.eighth'" /></td>
				<td> <a href="javascript:void(0)" class="easyui-linkbutton"
			iconCls="icon-save" plain="true" onclick="savePiLiang()">保存修改</a></td>
			</tr>
		</table>
</div>
